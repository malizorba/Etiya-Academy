...
(
    ...
    CONSTRAINT cart_details_pkey PRIMARY KEY (product_id, cart_id)
);
...
(
    ...
    national_identity character varying COLLATE pg_catalog."default" NOT NULL,
...
(
    id integer NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
    name character varying COLLATE pg_catalog."default" NOT NULL,
    supplier_detail_id integer NOT NULL,
...
ALTER TABLE IF EXISTS public.addresses
    ADD CONSTRAINT address_street_fk FOREIGN KEY (street_id)
...
ALTER TABLE IF EXISTS public.cart_details
    ADD CONSTRAINT cart_detail_cart_fk FOREIGN KEY (cart_id)
...
ALTER TABLE IF EXISTS public.cart_details
    ADD CONSTRAINT cart_detail_product_fk FOREIGN KEY (product_id)
...
ALTER TABLE IF EXISTS public.customers
    ADD CONSTRAINT customer_corporate_customer_fk FOREIGN KEY (corporate_customer_id)
...
ALTER TABLE IF EXISTS public.customers
    ADD CONSTRAINT customer_individual_customer_fk FOREIGN KEY (individual_customer_id)
...
ALTER TABLE IF EXISTS public.payments
    ADD CONSTRAINT payment_payment_type_fk FOREIGN KEY (payment_type_id)
...
ALTER TABLE IF EXISTS public.product_categories
    ADD CONSTRAINT "productCategories_category_fk" FOREIGN KEY (category_id)
...
ALTER TABLE IF EXISTS public.supplier_details
    ADD CONSTRAINT supplier_detail_product_fk FOREIGN KEY (product_id)
    REFERENCES public.products (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.suppliers
    ADD CONSTRAINT supplier_supplier_detail_fk FOREIGN KEY (supplier_detail_id)
